...
def map_at_k(r, k):
    ...
    Ref: https://medium.com/swlh/rank-aware-recsys-evaluation-metrics-5191bba16832
    Args:
        r: means relevant, is binary (nonzero is relevant)
        k: top k, must less than max_K
    Returns:
    ...
    ap_precision_score = ap_precision.sum(1) / pred_data.sum(1)
    return ap_precision_score
